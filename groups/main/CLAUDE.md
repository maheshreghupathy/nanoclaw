...
**IMPORTANT:** The JID `tg:8795783159` is the owner's personal chat and is already registered as the main group. Do NOT re-register it, rename it, or change its folder. Never call `register_group` for this JID.
